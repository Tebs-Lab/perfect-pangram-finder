 ...
 */
function constructLetterShareHist(validWords, alphabet) {
	var letterShareHist = {};
	var totalSum = 0;
...
module.exports = {
  ...
  removeLetters,
  prunedWordList,
  constructFreqHistogram,
  constructLetterShareHist
}
