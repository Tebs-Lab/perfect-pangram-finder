...
// /*
//   This function takes a word list and creates a "Cannon Dictionary", for
//   reversing the values stored in compact dictionaries. The returned Map
//   will map sorted letter sets to all the words that can be fomed with those
//   letters.
// */
// function createCompactDictionary(wordList, alphabet) {
//   let compactDictionary = new Map();
